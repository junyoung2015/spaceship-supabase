...
Share only the redacted output unless a maintainer asks for the sanitized `--verbose` result. Remove project references, labels, full filesystem paths, credentials, and configuration values that you do not intend to disclose.
